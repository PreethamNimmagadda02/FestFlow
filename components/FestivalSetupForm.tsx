...
export const EventSetupForm: React.FC<EventSetupFormProps> = React.memo(({ onSubmit, isLoading }) => {
    ...
    return (
        <div className="bg-secondary p-6 rounded-xl shadow-2xl border border-accent animate-fadeIn">
            <h2 className="text-xl font-bold mb-2 text-highlight">1. Define Your Event Goal</h2>
